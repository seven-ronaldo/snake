...
{
   return a + rand()%(b-a+1); //rand co nghia la lay gia tri tu 0 toi rand_max(32767)
}
...
void initgame(){
	...
	character[3] = 11210;
	character[4] = 11110;
	character[5] = 11010;   //NOTE:ham khoi tao cac gia tri ban dau
	character[6] = 10910;
	character[7] = 10810;
	character[8] = 10710;
	character[9] = 10610;
...
void creatfruit(){
	...
	while(notok){
		notok = 0;
		fruit = 10000 + Random(1,77)*100 + Random(1,23); //NOTE: ham xuat hien moi theo vi tri ngau nhien 
		int i = 0;
		for(i;i<length;i++){
